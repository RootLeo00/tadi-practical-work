...
# Gray-scale images
#im = skio.imread('/home/leo/tadi/TP-morpho/TP-morpho/Images/retina2.gif')

#im = skio.imread('/home/leo/tadi/TP-morpho/TP-morpho/Images/bat200.bmp')

#im = skio.imread('/home/leo/tadi/TP-morpho/TP-morpho/Images/bulles.bmp')
#im = grayscale_from_color(skio.imread('/home/leo/tadi/TP-morpho/TP-morpho/Images/cailloux.png'))
#im = grayscale_from_color(skio.imread('/home/leo/tadi/TP-morpho/TP-morpho/Images/cailloux2.png'))
im = skio.imread('/home/leo/tadi/TP-morpho/TP-morpho/Images/laiton.bmp')
...
for struct_el in structuring_elements_list:
    for size in sizes:
        ...
        plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/dil_{struct_el}_{size}.png')

        # Erosion
        ero = morpho.erosion(im, se)
        plt.imshow(ero, cmap="gray", vmin=0, vmax=255)
        plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/ero_{struct_el}_{size}.png')

        # Opening
        open = morpho.opening(im, se)
        plt.imshow(open, cmap="gray", vmin=0, vmax=255)
        plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/open_{struct_el}_{size}.png')

        # Closing
        close = morpho.closing(im, se)
        plt.imshow(close, cmap="gray", vmin=0, vmax=255)
        plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/close_{struct_el}_{size}.png')
...
plt.imshow(dil, cmap="gray", vmin=0, vmax=255)
plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/ex3_successivedils_dil_{struct_el}_{size}.png')

# sum of dilations
# Dilation 8x8
dil = morpho.dilation(im, strel('square', 8))
plt.imshow(dil, cmap="gray", vmin=0, vmax=255)
plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/ex3_sumofdils_dil_{struct_el}_{size}.png')
...
plt.imshow(dil, cmap="gray", vmin=0, vmax=255)
plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/ex3_successiveopen_open_{struct_el}_{size}.png')

# sum of openings
# Opening 8x8
dil = morpho.opening(im, strel('square', 8))
plt.imshow(dil, cmap="gray", vmin=0, vmax=255)
plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/ex3_sumofopen_open_{struct_el}_{size}.png')
    ...
    for size in sizes:
        if struct_el == 'line':
            for angle in angles:
                ...
                plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/ex4_tophat_{struct_el}_{size}_{angle}.png')
        
        else:
                se = strel(struct_el, size)
                ch = im - morpho.opening(im, se)
                plt.imshow(ch, cmap="gray", vmin=0, vmax=255)
                plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/ex4_tophat_{struct_el}_{size}.png')
...
plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/ex4_tophat_max_{struct_el}_{size}_{angle}.png')
    ...
    for size in sizes:
        if struct_el == 'line':
            for angle in angles:
                ...
                plt.imshow(ch, cmap="gray", vmin=0, vmax=255)
                plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/ex4_bottomhat_{struct_el}_{size}_{angle}.png')
        
        else:
                se = strel(struct_el, size)
                ch =  morpho.closing(im, se) -im
                plt.imshow(ch, cmap="gray", vmin=0, vmax=255)
                plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/ex4_bottomhat_{struct_el}_{size}.png')
...
for i in range (0, len(ch)):
    if i == len(ch)-1:
        ...
        res= np.maximum(ch[i], ch[i+1])
plt.imshow(res, cmap="gray", vmin=0, vmax=255)
plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/ex4_bottomhat_max_{struct_el}_{size}_{angle}.png')
...
plt.imshow(res, cmap="gray", vmin=0, vmax=255)
plt.savefig(f'/home/leo/tadi/TP-morpho/TP-morpho/results/ex5_open_max_{struct_el}_{size}_{angle}.png')
